...
- [ ] 10.1 Implement bounded explicit consumer contract loading and no-spec compatibility checks. [INT-006]
- [ ] 10.2 Implement input parity, sanitization and budgets for context-only/enforced arms. [CTX-006]
- [ ] 10.3 Implement generic before-recovery admission and refusal/unknown tests on independent synthetic inputs. [HEAL-008]
