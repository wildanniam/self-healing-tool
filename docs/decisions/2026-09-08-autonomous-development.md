...
Scope: library, bounded recovery, context, reporting, independent synthetic demo, and preparation for private integration. Paid execution, final-study freeze, distribution eligibility/license, human participation, merge and publication keep their applicable owner decisions. Only the dependent action waits; independent work continues. This instruction does not resolve ownership of existing reference code or authorize paid requests by filling an environment file.
