...
const study=JSON.parse(readFileSync(new URL('./d30-config.json',import.meta.url),'utf8'));
const path=resolve(process.argv[2]??'output/d30/budget.json');
const {config,regression,holdout,private:privateWorkload,runOrder,limits,...plan}=study;
